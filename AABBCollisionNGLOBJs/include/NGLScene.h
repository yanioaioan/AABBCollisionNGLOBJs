...
class NGLScene : public QOpenGLWindow
{
  public:
    ...
    bool checkCollision(float meshUpdatedHalfWidth,
...
private:
    ...
    //AABB center points
    ngl::Vec3 meshUpdatedCenter;
    ngl::Vec3 prevMeshCenter;
    ngl::Vec3 mesh2UpdatedCenter;
    ngl::Vec3 prevMesh2Center;

    //AABB half widths,heigths, depths
    float meshUpdatedHalfWidth;
    float meshUpdatedHalfHeight;
    float meshUpdatedHalfDepth;
    float mesh2UpdatedHalfWidth;
    float mesh2UpdatedHalfHeight;
